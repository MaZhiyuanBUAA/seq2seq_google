...
tf.app.flags.DEFINE_string('model_dir', 'nn_models', 'Train directory')
...
tf.app.flags.DEFINE_integer('vocab_size', 8000, 'Dialog vocabulary size.')
...
#BUCKETS = [(10, 15), (20, 25),(40,50)]#chatbot
BUCKETS = [(15, 20), (20, 30), (30, 50)]
